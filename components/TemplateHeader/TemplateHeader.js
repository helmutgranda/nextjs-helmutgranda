...
<header id="masthead" class="site-header">
        <div id="header-bg" class="site-header-bg" style={{backgroundImage: "url('images/header-bg.jpg')"}}></div>
                ...
                <div class="site-nav-wrap">
                  <div class="site-nav-inside">
                    ...
                    <div class="social-links">
                      ...
                      <a href="https://www.linkedin.com/helmutgranda" target="_blank" rel="noopener " class="button-circle">
                        <svg class="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
